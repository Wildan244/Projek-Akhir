...
int hariSimulasi = 0;
int batasPengeluaranBulanan = 1000000; // Batas pengeluaran bulanan, contoh: 1jt
...
void tarikSaldo() {
    ...
    tambahKeRekap("Tarik");
    tampilkanTransaksi(); // Tampilkan transaksi terbaru setelah aksi
}
...
int main() {
    ...
    while (true) {
        ...
        if (opsiAwal == 1) {
            ...
            // membuat loading agar lebih rapi
            cout << "\nMemuat data, mohon tunggu";
            cout.flush();
            cout << endl;
            cls(); // membersihkan layar setelah loading
            ...
            if (username == "admin" && password == "123") {
                    ...
                    switch (pilihan) {
                        ...
                        case 2 : 
                            if (jumlahTransaksi == 0) {
                                cout << "Belum ada transaksi yang bisa diurutkan.\n";
                                break;
                            }

                            int modeUrut;
                            cout << "Pilih metode pengurutan : \n";
                            cout << "1. Berdasarkan jumlah transaksi (terbesar ke terkecil)\n";
                            cout << "2. Berdasarkan jenis transaksi (A-Z)\n";
                            cout << "Masukan pilihan : ";
                            cin >> modeUrut;

                            if (modeUrut == 1 || modeUrut == 2) {
                                bubbleSortTransaksi(modeUrut); // sorting
                                cout << "Transaksi berhasil diurutkan.\n";
                                tampilkanTransaksi();
                            } else {
                                cout << "Pilihan tidak valid.\n";
                            }
                        ...
                        case 6:
                            ...
                            break;
                        case 7:
                            menuAdmin = false; // Kembali ke menu utama, jangan return/exit ya
                            break;
                        default :
                            cout << "Pilihan tidak valid.\n";
                    }
                ...
                // Mencari user pada array pengguna(searching)
                ...
                cls();
                simpanKeFile(); // menyimpan data ke file setelah login
